    ...
    def grid(query,
        ...
        if ui == 'jquery-ui':
            ...
            ui = dict(widget='',
                      ...
                      cornertop='',
                      cornerbottom='',
                      button='button btn btn-default btn-primary',
        ...
        if create and request.args(-2) == 'new':
            ...
            sqlformargs = dict(ignore_rw=ignore_rw, formstyle=formstyle,
                               _class='m-3 border border-primary text-light rounded p-3 container bg-dark')
        ...
        if rows:
            ...
            htmltable = TABLE(COLGROUP(*cols), THEAD(head,_class="thead-dark"),_class="table table-hover table-dark table-striped")
            tbody = TBODY()
            numrec = 0
        ...
        if csv and nrows:
            ...
            for k, v in sorted(exportManager.items()):
                ...
                link = url2(vars=dict(
                    ...
                    _export_type=k,
                    keywords=keywords))
                export_links.append(A(T(label), _href=link, _title=title, _class='btn btn-outline-primary btn-sm'))
            export_menu = \
